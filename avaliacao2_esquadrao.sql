...
--
-- Host: localhost    Database: avaliacao2
-- ------------------------------------------------------
...
CREATE TABLE `esquadrao` (
  `id_heroi` bigint unsigned NOT NULL AUTO_INCREMENT,
  `heroi` varchar(50) NOT NULL,
  `poder` varchar(255) NOT NULL,
  `id_usuario` int DEFAULT NULL,
  PRIMARY KEY (`id_heroi`),
  UNIQUE KEY `id_heroi` (`id_heroi`),
...
INSERT INTO `esquadrao` VALUES (1,'Batman','Mestre em artes marciais, mestre detetive, mestre ninja, mestre hacker',1),(2,'Herói Teste','Poder teste',1),(3,'Hulububa','Hulububa',10);
...
-- Dump completed on 2022-10-26 23:14:56
